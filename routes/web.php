...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/commentaires/ajout', [CommentaireController::class, 'create']);
    Route::post('/commentaires/ajoute', [CommentaireController::class, 'store'])->name('commentaires.store');
});
