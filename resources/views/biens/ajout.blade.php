            ...
            <div class="card-body">
                ...
                <form method="post" action="/AjoutBien" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nomDescrition" placeholder="Ajouter une description" name="description">
                    </div>

                    <div class="form-group">
                        <label for="nomAdresse">Adresse</label>
                        <input type="text" class="form-control" id="nomAdresse" placeholder="Enter une Adresse" name="adresse">
                    </div>
